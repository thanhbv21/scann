...
namespace Scannn.iOS
{
    ...
    {
        public static string HostName = "http://www.google.com";
        ...
        public static NetworkStatus InternetConnectionStatus()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("defaultNetworkAvailable && ((flags & NetworkReachabilityFlags.IsDirect) != 0)");
                return NetworkStatus.NotReachable;
            }
            ...
            {
                System.Diagnostics.Debug.WriteLine("(flags & NetworkReachabilityFlags.IsWWAN) != 0");
            ...
            if (flags == 0)
            {
                System.Diagnostics.Debug.WriteLine("(flags == 0)");
